...
export const attendanceReminderFields: WebUiFormField[] = [WebUiFormField.input('name', { label: 'name' })]

// TODO: Populate Select Fields
export const attendanceReminderSelectFields: SelectFieldOptions[] = [
