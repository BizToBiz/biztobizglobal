...
import { useAdminUsersQuery, User } from '@biztobiz/shared/util-sdk'
...
export default function WebUiUserSelect(props: WebUiUserSelectProps) {
  const [query, setQuery] = useState('')
  const { data, loading } = useAdminUsersQuery({ variables: { input: { take: 20, search: query } } })
